...
def evaluate(
    predictions: str = typer.Option(
        ...
        help=(
            ...
            "Must contain: barcode, ctc_probability, predicted_label."
        ),
        rich_help_panel="Input/Output",
    ),
    ground_truth: str | None = typer.Option(
        ...
        help=(
            ...
            "If provided, AUROC, AUPRC, sensitivity, specificity,\n"
            "and confusion matrix will be computed along with ROC/PR curve plots."
        ),
        rich_help_panel="Input/Output",
    ),
